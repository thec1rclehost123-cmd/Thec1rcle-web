      ...
      <div className="relative z-10 w-full max-w-[1600px] px-6 lg:px-12 py-8 lg:py-16">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              <div className="px-6 py-2 rounded-full bg-[#F44A22]/20 border border-[#F44A22]/40 backdrop-blur-md">
                <p className="text-sm font-black uppercase tracking-[0.3em] text-[#F44A22]">
            ...
            <motion.h1
              ...
              className="text-6xl sm:text-7xl md:text-8xl lg:text-9xl font-heading font-black text-white uppercase leading-[0.9] tracking-tight"
              style={{
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <div className="flex flex-col sm:flex-row gap-2 sm:gap-5 text-xl text-white/90 font-bold justify-center lg:justify-start">
                <div className="flex items-center gap-2 justify-center lg:justify-start">
                  <svg className="w-6 h-6 text-[#F44A22]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center gap-2 text-lg text-white/70 justify-center lg:justify-start">
                <svg className="w-6 h-6 text-[#F44A22]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            >
              <Link
                ...
                className="group relative px-12 py-6 bg-white text-black font-black uppercase tracking-[0.2em] text-lg rounded-full overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.5)]"
              >
              ...
              <div className="flex items-center gap-3 px-6 py-3 rounded-full bg-white/10 backdrop-blur-md border border-white/20">
                <div className="flex -space-x-3">
                  {[1, 2, 3, 4].map((i) => (
                    <div
                      key={i}
                      className="w-10 h-10 rounded-full bg-gradient-to-br from-[#F44A22] to-[#FF6B4A] border-2 border-white/20"
                      style={{
                ...
                <span className="text-white font-bold text-sm">+156 Going</span>
              </div>
            </motion.div>
          </motion.div>
          ...
          <motion.div
            ...
            className="relative order-1 lg:order-2 group perspective-1000"
          >
